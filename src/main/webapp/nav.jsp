   <%@ page language="java" isELIgnored="false" contentType="text/html; charset=utf-8"%>
    <div class="navbar navbar-fixed-top" id="nav">
		    <div class="container" style="width: 1000px;">
		        ...
		        <p class="navbar-text">
		            <a href="main.jsp" class="navbar-link" id="link">首页</a>
		        </p>
		        <p class="navbar-text">
		            <a href="#" class="navbar-link" id="link">菜谱分类</a>
		        </p>
		        <p class="navbar-text">
		            <a href="#" class="navbar-link" id="link">菜单</a>
		        </p>
		        <p class="navbar-text">
		            <a href="#" class="navbar-link" id="link">作品动态</a>
		        </p>
		        </div>
		    </div>
    </div>
    <div class="drop_border">
        <div class="drop_line">
         	<a href="kitchen.jsp" id="link">我的厨房</a>
        </div>
        <div class="drop_line">
         	<a href="#" id="link">我的菜单</a>
        </div>
        <div class="drop_line">
         	<a href="#" id="link">账号设置</a>
        </div>
        <div class="drop_line">
         	<a href="#" id="link">注销</a>
        </div>
