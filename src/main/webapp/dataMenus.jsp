              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="active" href="${pageContext.request.contextPath}/admin/menus/all">菜单管理</a></li>
                      ...
                      <section class="panel">
                          ...
                          <c:if test="${not empty mslist }">
	                          ...
	                          <tr class="odd gradeX">
	                              <th style="width:8px;"><i class=" icon-star-empty"></i></th>
	                              <td>${msl.index + 1 }</td>
	                              <td class="hidden-phone">${ums.menus.msName }</td>
	                              <td class="hidden-phone">${ums.menus.msInfo }</td>
	                              <td class="hidden-phone">${ums.u.uName }</td>
	                              <%
                          				...
                          				<td colspan="7" style="text-align: center;">
                          					<ul class="pagination">
												...
												<c:if test="${page.pageNow ne 1}">
													<li><a href="${pageContext.request.contextPath}/admin/menus/all?currentpage=${page.pageNow-1}">&laquo;</a></li>
											    </c:if>
											    <li><a href="#">${page.pageNow }</a></li>
											    <c:if test="${page.pageNow ne page.totalPageCount}">
											        <li><a href="${pageContext.request.contextPath}/admin/menus/all?currentpage=${page.pageNow+1}">&raquo;</a></li>
											    </c:if>
											</ul>
                          				</td>
                          		</tr>
